<!-- client/custom/modules/interfaz/res/templates/modals/subir-copy.tpl -->
...
<div class="int-modal-form">
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="int-copy-nombre" maxlength="255" placeholder="Ej: Guión de llamada - Compradores">
    </div>

    <div class="form-group">
        <label for="int-copy-descripcion">Descripción</label>
        <textarea class="form-control" id="int-copy-descripcion" rows="3" placeholder="Breve descripción del contenido (opcional)"></textarea>
    </div>

    <div class="form-group">
        <label for="int-copy-file">Archivo <span class="text-danger">*</span></label>
